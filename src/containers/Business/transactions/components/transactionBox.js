  ...
  <Card style={{ marginBottom: "10px" }}>
    <Row gutter={16}>
      <Col md={2} xs={24} style={{}}>
        ...
        >
          <Icon
            type={transaction.type == "discount" ? "arrow-down" : transaction.type == "refund" ? "arrow-up" : "arrow-right"}
            style={{ fontSize: "30px", color: "#fff" }}
          />
        </div>
      </Col>
      <Col md={12} xs={24} style={{ marginBottom: "15px", fontSize: "1.4em", fontWeight: 300 }}>
      ...
      <Col md={6} xs={24}>
        ...
        <div className="tx_list_item_data_container">
          ...
          <span className="second">{parseFloat(transaction.discount).toFixed(2)}%</span>
        </div>
        ...
        <div className="tx_list_item_data_container">
          ...
          <span className="second">${parseFloat(transaction.bill_amount).toFixed(2)}</span>
        </div>
        ...
        <div className="tx_list_item_data_container">
          ...
          <span className="second">{transaction.bill_id && transaction.bill_id != "None" ? transaction.bill_id : "N/D"}</span>
        </div>
        ...
        <div className="tx_list_item_data_container">
          ...
          <span className="second">{moment(transaction.date).format("YYYY-MM-DD HH:mm:ss")}</span>
        </div>
      ...
      <Col md={4} xs={24} style={{ height: "100%" }}>
        <div className="tx_list_item">
          <div className="tx_list_item_container">
            <img alt="#" src="/static/media/logo.035fac34.png" height="12" className="tx_list_item_amount_icon" />
