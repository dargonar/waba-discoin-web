...
const formatSchedules = formData => {
  ...
  formData.discount_schedule = formData.discount_schedule.map((value, key) => {
    ...
    console.log(' ---- const formatSchedules = formData => ', '[value]:', value, '[key]:', key, '[formated]:', formated)

    formated.discount = value.discount;
    formated.reward   = value.reward;
    return formated;
  });
...
class CreateStore extends Component {
  ...
  submit() {
    ...
    this.props.form.validateFields((err, val) => {
      if (err === null) {
        var obj = Object.assign({}, this.props.business, result);
        console.log('----------------------- saving business:', JSON.stringify(obj));
        this.props.saveBusiness(obj);
      } else {
                ...
                <FormItem label="Rates">
                  ...
                  >
                    <Col sm={3}>
                      ...
                      >
                        <Col> Type </Col> <Col>Recompensa </Col>
                        <Col> Descuento </Col>
                      </Row>
                    </Col>
